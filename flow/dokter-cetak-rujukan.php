    ...
    <section class="back">
        <table>
            <tr>
                ...
                <td><span class="top">Cetak Rujukan</span></td>
            </tr>
        </table>

        <embed src="SURAT_RUJUKAN_RUMAH_SAKIT.pdf" type="application/pdf" class="doc-resep"></embed>

        <div class="button">
            <a href="SURAT_RUJUKAN_RUMAH_SAKIT.pdf" download="SURAT_RUJUKAN_RUMAH_SAKIT.pdf" class="cetak">Cetak</a>
        </div>
    </section>
  </div>
